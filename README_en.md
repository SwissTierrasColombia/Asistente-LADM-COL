...
The current version ([3.1.2](https://github.com/SwissTierrasColombia/Asistente-LADM-COL/releases/tag/3.1.2)) of the LADM-COL Assistant depends on [QGIS Model Baker v6.1.1.5](https://github.com/SwissTierrasColombia/QgisModelBaker/releases/download/v6.1.1.4/QgisModelBaker_6115.zip) and allows users to:
