...
RUN wget https://github.com/opengisch/projectgenerator/releases/download/v3.3.0/projectgenerator.v3.3.0.zip -O /tmp/projectgenerator.zip

# When we need a custom release
# RUN wget https://github.com/AgenciaImplementacion/projectgenerator/releases/download/3.2.7.2/projectgenerator.zip -O /tmp/projectgenerator.zip
