...
REFACTORED_DB_PATH = '/docs/tr/ai/productos/uaecd/resultados_intermedios/refactored_01.gpkg'
...
OUTPUT_DB_SCHEMA = 'ladm_col_uaecd_manzana_01'
...
def llenar_col_derecho():
    ...
    # Col_Derecho
    params_refactor_col_derecho = { 'INPUT' : '{}'.format(INPUT_PREDIO_INTERESADO_PATH), 'FIELDS_MAPPING' : [{'name': 't_id', 'type': 4, 'length': -1, 'precision': 0, 'expression': '"t_id"'}, {'name': 'tipo', 'type': 10, 'length': 255, 'precision': -1, 'expression': '"Col_DerechoTipo"'}, {'name': 'codigo_registral_derecho', 'type': 10, 'length': 3, 'precision': -1, 'expression': '"codigo_registral_derecho"'}, {'name': 'descripcion', 'type': 10, 'length': 255, 'precision': -1, 'expression': '"descripcion"'}, {'name': 'comprobacion_comparte', 'type': 1, 'length': -1, 'precision': -1, 'expression': '"comprobacion_comparte"'}, {'name': 'uso_efectivo', 'type': 10, 'length': 255, 'precision': -1, 'expression': '"uso_efectivo"'}, {'name': 'r_espacio_de_nombres', 'type': 10, 'length': 255, 'precision': -1, 'expression': "'UAECD_col_derecho'"}, {'name': 'r_local_id', 'type': 10, 'length': 255, 'precision': -1, 'expression': '"OBJECTID"'}, {'name': 'interesado_interesado_juridico', 'type': 4, 'length': -1, 'precision': 0, 'expression': '"interesado_interesado_juridico"'}, {'name': 'interesado_la_agrupacion_interesados', 'type': 4, 'length': -1, 'precision': 0, 'expression': '"interesado_la_agrupacion_interesados"'}, {'name': 'unidad_la_baunit', 'type': 4, 'length': -1, 'precision': 0, 'expression': '"unidad_la_baunit"'}, {'name': 'comienzo_vida_util_version', 'type': 16, 'length': -1, 'precision': -1, 'expression': 'now()'}, {'name': 'fin_vida_util_version', 'type': 16, 'length': -1, 'precision': -1, 'expression': '"fin_vida_util_version"'}, {'precision': 0, 'name': 'unidad_predio', 'length': -1, 'type': 4, 'expression': '"t_id_predio"'}, {'precision': 0, 'name': 'interesado_interesado_natural', 'length': -1, 'type': 4, 'expression': '"t_id_interesado"'}], 'OUTPUT' : 'ogr:dbname="{refactored_db_path}" table="R_col_derecho" (geom) sql='.format(refactored_db_path=REFACTORED_DB_PATH) }
    #input_interesado_natural = QgsVectorLayer(input_uri, "r_interesado_natural", "ogr")
...
def llenar_fuente_administrativa():
    ...
    refactor_and_copy_paste(params_fuente_administrativa, input_uri_col_fte_adminis, output_col_fte_adminis)
