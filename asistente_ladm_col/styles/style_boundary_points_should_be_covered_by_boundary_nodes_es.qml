...
<qgis version="3.4.1-Madeira" styleCategories="Symbology">
  <renderer-v2 symbollevels="0" attr="error_type" enableorderby="0" type="categorizedSymbol" forceraster="0">
    <categories>
      <category symbol="0" value="Punto lindero no esta cubierto por un nodo de un lindero" label="Punto lindero no esta cubierto por un nodo de un lindero" render="true"/>
