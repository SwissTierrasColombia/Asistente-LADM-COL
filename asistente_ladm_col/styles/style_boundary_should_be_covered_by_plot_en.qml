...
<qgis styleCategories="Symbology" version="3.4.1-Madeira">
  <renderer-v2 attr="error_type" enableorderby="0" symbollevels="0" forceraster="0" type="categorizedSymbol">
    <categories>
      ...
      <category value="Topological relationship between boundary and plot not recorded in the menos table" symbol="4" render="true" label="Topological relationship between boundary and plot not recorded in the menos table"/>
    </categories>
    <symbols>
