...
from asistente_ladm_col.config.keys.role_keys import (MANAGER_ROLE,
                                                      OPERATOR_ROLE,
...
class TransitionalSystemConfig(QObject, metaclass=SingletonQObject):
    ST_DEFAULT_DOMAIN = "https://apist.proadmintierra.info"  # "https://apist-pruebas.proadmintierra.info"
