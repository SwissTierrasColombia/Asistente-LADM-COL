...
QUALITY_RULE_ERROR_CODE_E400706 = PREFIX_ERROR_CODE + str(EnumQualityRule.Logic.COL_PARTY_NATURAL_TYPE.value) + '06'
QUALITY_RULE_ERROR_CODE_E400707 = PREFIX_ERROR_CODE + str(EnumQualityRule.Logic.COL_PARTY_NATURAL_TYPE.value) + '07'
QUALITY_RULE_ERROR_CODE_E400708 = PREFIX_ERROR_CODE + str(EnumQualityRule.Logic.COL_PARTY_NATURAL_TYPE.value) + '08'
QUALITY_RULE_ERROR_CODE_E400709 = PREFIX_ERROR_CODE + str(EnumQualityRule.Logic.COL_PARTY_NATURAL_TYPE.value) + '09'
QUALITY_RULE_ERROR_CODE_E400710 = PREFIX_ERROR_CODE + str(EnumQualityRule.Logic.COL_PARTY_NATURAL_TYPE.value) + '10'
QUALITY_RULE_ERROR_CODE_E400711 = PREFIX_ERROR_CODE + str(EnumQualityRule.Logic.COL_PARTY_NATURAL_TYPE.value) + '11'
QUALITY_RULE_ERROR_CODE_E400712 = PREFIX_ERROR_CODE + str(EnumQualityRule.Logic.COL_PARTY_NATURAL_TYPE.value) + '12'
QUALITY_RULE_ERROR_CODE_E400713 = PREFIX_ERROR_CODE + str(EnumQualityRule.Logic.COL_PARTY_NATURAL_TYPE.value) + '13'
...
QUALITY_RULE_ERROR_CODE_E400805 = PREFIX_ERROR_CODE + str(EnumQualityRule.Logic.COL_PARTY_NOT_NATURAL_TYPE.value) + '05'
QUALITY_RULE_ERROR_CODE_E400806 = PREFIX_ERROR_CODE + str(EnumQualityRule.Logic.COL_PARTY_NOT_NATURAL_TYPE.value) + '06'
QUALITY_RULE_ERROR_CODE_E400807 = PREFIX_ERROR_CODE + str(EnumQualityRule.Logic.COL_PARTY_NOT_NATURAL_TYPE.value) + '07'
...
QUALITY_RULE_ERROR_CODE_E402301 = PREFIX_ERROR_CODE + str(EnumQualityRule.Logic.INCONSISTENT_BUILDING_UNIT.value) + '01'
QUALITY_RULE_ERROR_CODE_E402302 = PREFIX_ERROR_CODE + str(EnumQualityRule.Logic.INCONSISTENT_BUILDING_UNIT.value) + '02'
QUALITY_RULE_ERROR_CODE_E402303 = PREFIX_ERROR_CODE + str(EnumQualityRule.Logic.INCONSISTENT_BUILDING_UNIT.value) + '03'
        ...
        return {
            ...
            EnumQualityRule.Logic: {
                ...
                QUALITY_RULES: {
                    ...
                    EnumQualityRule.Logic.INCONSISTENT_BUILDING_UNIT: {
                        QUALITY_RULE_ID: EnumQualityRule.Logic.INCONSISTENT_BUILDING_UNIT,
