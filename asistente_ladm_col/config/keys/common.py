...
ACTION_LOAD_TEMPLATE_FIELD_DATA = 'action_load_template_field_data'
...
ACTION_EXPORT_DATA_FDC_COORDINATOR = 'action_export_data_fdc_coord'
ACTION_DATA_MODEL_CONVERTER = 'action_data_model_converter'
