...
Choose this option if you want to create a <b>Restriction</b> based on existing <b>Administrative Source</b>.\
<br><br>\
...
Choose this option if you want to create a <b>Right</b> based on existing <b>Administrative Source</b>.\
<br><br>\
