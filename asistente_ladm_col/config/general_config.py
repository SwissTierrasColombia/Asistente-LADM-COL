...
# Configure InvisibleLayersAndGroups Dependency
INVISIBLE_LAYERS_AND_GROUPS_PLUGIN_NAME = "InvisibleLayersAndGroups"
INVISIBLE_LAYERS_AND_GROUPS_MIN_REQUIRED_VERSION = "2.0"
INVISIBLE_LAYERS_AND_GROUPS_EXACT_REQUIRED_VERSION = False
