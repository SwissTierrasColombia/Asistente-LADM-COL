...
ILIVALIDATOR_ERRORS_CATALOGUE_PATH = os.path.join(PLUGIN_DIR, 'resources', 'models', 'catalogo_errores_ilivalidator.xtf')
IGAC_ERRORS_CATALOGUE_PATH = os.path.join(PLUGIN_DIR, 'resources', 'models', 'catalogo_errores.xtf')
