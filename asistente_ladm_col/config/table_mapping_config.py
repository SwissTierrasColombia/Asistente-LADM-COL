...
LA_DIMENSION_TYPE = "la_dimensiontipo"
LA_EDIFICATION_UNIT_TYPE = "la_unidadedificaciontipo"
LA_POINT_TYPE_TABLE = "la_puntotipo"
LA_SURFACE_RELATION_TYPE = "la_relacionsuperficietipo"
...
POINT_AGREEMENT_TYPE = "col_acuerdotipo"
