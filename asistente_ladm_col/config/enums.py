...
class EnumQualityRule:
    ...
    class Logic(Enum):
        ...
        # 4002 could be taken, it was used in early stages of the model, but then we discarded it
        ...
        DUPLICATE_RECORDS_IN_BOUNDARY_POINT = 4012
        DUPLICATE_RECORDS_IN_SURVEY_POINT = 4013
        DUPLICATE_RECORDS_IN_CONTROL_POINT = 4014
        DUPLICATE_RECORDS_IN_BOUNDARY = 4015
        DUPLICATE_RECORDS_IN_PLOT = 4016
        DUPLICATE_RECORDS_IN_BUILDING = 4017
        DUPLICATE_RECORDS_IN_BUILDING_UNIT = 4018
        DUPLICATE_RECORDS_IN_PARCEL = 4019
        DUPLICATE_RECORDS_IN_PARTY = 4020
        DUPLICATE_RECORDS_IN_RIGHT = 4021
        DUPLICATE_RECORDS_IN_RESTRICTION = 4022
        DUPLICATE_RECORDS_IN_ADMINISTRATIVE_SOURCE = 4023