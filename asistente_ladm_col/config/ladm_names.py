...
class LADMNames(metaclass=Singleton):
    ...
    SURVEY_MODEL_PREFIX = "Levantamiento_Catastral"
    ANT_MODEL_PREFIX = "ANT"
    REFERENCE_CADASTRAL_CARTOGRAPHY_PREFIX = "Cartografia_Catastral_Referencia"
    ...
    LATEST_SURVEY_MODEL_VERSION_SUPPORTED = "2.11"
    LATEST_LADM_MODEL_VERSION_SUPPORTED = "1.7"
    ...
    SUPPORTED_ISO_CARTESIAN_COORDINATES = 'ISO19107_PLANAS_V2'
    ...
    DEFAULT_INTERLIS_MODEL = 'INTERLIS'
    ...
    DEFAULT_HIDDEN_MODELS = [SUPPORTED_LADM_MODEL, DEFAULT_INTERLIS_MODEL, SUPPORTED_ISO_CARTESIAN_COORDINATES]
