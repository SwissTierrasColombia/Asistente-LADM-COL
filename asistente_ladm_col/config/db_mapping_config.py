...
class DBMappingConfig:
    ...
    __DB_MAPPING_CONFIG = {
        ...
        LADMNames.SURVEY_MODEL_KEY: {
            ...
            "Modelo_Aplicacion_LADMCOL_Lev_Cat.Levantamiento_Catastral.LC_DatosAdicionalesLevantamientoCatastral": {QueryNames.VARIABLE_NAME: "LC_SURVEY_CADASTRAL_ADITIONAL_DATA_T", QueryNames.FIELDS_DICT: {}},
