...
from asistente_ladm_col.logic.quality_rules.line_qrs.qr_overlapping_boundaries import QROverlappingBoundaries
from asistente_ladm_col.logic.quality_rules.polygon_qrs.qr_overlapping_buildings import QROverlappingBuildings
from asistente_ladm_col.logic.quality_rules.line_qrs.qr_plots_covered_by_boundaries import QRPlotsCoveredByBoundaries
from asistente_ladm_col.logic.quality_rules.polygon_qrs.qr_overlapping_right_of_ways import QROverlappingRightOfWays
from asistente_ladm_col.logic.quality_rules.polygon_qrs.qr_overlapping_right_of_ways_buildings import QROverlappingRightOfWaysBuildings
from asistente_ladm_col.logic.quality_rules.qr_validate_data_against_model import QRValidateDataAgainstModel
from asistente_ladm_col.logic.quality_rules.polygon_qrs.qr_gaps_in_plots import QRGapsInPlots
from asistente_ladm_col.logic.quality_rules.polygon_qrs.qr_multiparts_in_right_of_way import QRMultiPartsInRightOfWay
...
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_parcel_right_relationship import QRParcelRightRelationship
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_parcel_with_invalid_parcel_number import QRParcelWithInvalidParcelNumber
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_group_party_percentage_that_do_not_make_one import QRGroupPartyPercentageThatDoNotMakeOne
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_parcel_with_invalid_previous_parcel_number import QRParcelWithInvalidPreviousParcelNumber
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_validate_natural_party import QRValidateNaturalParty
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_parcel_with_invalid_department_code import QRParcelWithInvalidDepartmentCode
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_parcel_with_invalid_municipality_code import QRParcelWithInvalidMunicipalityCode
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_validate_legal_party import QRValidateLegalParty
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_duplicate_boundary_point_records import QRDuplicateBoundaryPointRecords
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_duplicate_survey_point_records import QRDuplicateSurveyPointRecords
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_duplicate_control_point_records import QRDuplicateControlPointRecords
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_duplicate_administrative_source_records import QRDuplicateAdministrativeSourceRecords
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_duplicate_boundary_records import QRDuplicateBoundaryRecords
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_duplicate_building_records import QRDuplicateBuildingRecords
from asistente_ladm_col.logic.quality_rules.logic_qrs.qr_duplicate_building_unit_records import QRDuplicateBuildingUnitRecords
