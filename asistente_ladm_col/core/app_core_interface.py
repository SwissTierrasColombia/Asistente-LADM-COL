...
class AppCoreInterface(QObject):
    ...
    def adjust_layer(self, input_layer, reference_layer, tolerance=0, behavior=None, fix=False, add_topological_points=False, input_only_selected=False):
        ...
        input_param = QgsProcessingFeatureSourceDefinition(input_layer.id(),
                                                           input_only_selected) if input_only_selected else input_layer
        params = {
            'INPUT': input_param,
        ...
        if add_topological_points:
            ...
            res = GeometryUtils().add_topological_vertices(res, res)  # Note: Topological points against the same result layer
