...
class TestGeomsLoad(unittest.TestCase):
    ...
    def test_valid_import_geom_3d_to_db_gpkg(self):
        ...
        run_etl_model(self.db_pg, point_layer, test_layer, self.names.OP_BOUNDARY_POINT_T)
        ...
        output = run_etl_model(self.db_pg, point_layer, test_layer, self.names.OP_BOUNDARY_POINT_T)
