            ...
            if geometry.type() == QgsWkbTypes.PointGeometry:
                ...
                for collection_item in collection:
                    if collection_item.type() == QgsWkbTypes.PointGeometry:
                        point_overlap[pair] = collection_item.asWkt()
                    elif collection_item.type() == QgsWkbTypes.LineGeometry:
                        line_overlap[pair] = collection_item.asWkt()

        ### lines ###
        expected_line_overlap = {
            '4-6': 'MultiLineString ((963980.77503829856868833 1077802.31638198206201196, 963926.86899802810512483 1077925.5301883143838495))',
            '10-12': 'MultiLineString ((963643.395574557245709 1077747.43814651435241103, 963543.5341855603037402 1077760.18016819190233946))',
            '1-6': 'MultiLineString ((963905.69162506482098252 1077713.75645868084393442, 964144.41837483353447169 1077577.06614228105172515),(964144.41837483353447169 1077577.06614228105172515, 964309.98692709254100919 1077617.49567248369567096))'
        }
        self.assertEqual(line_overlap, expected_line_overlap)

        ### points ###
        expected_point_overlap = {
            '3-10': 'MultiPoint ((963643.395574557245709 1077747.43814651435241103))',
            '5-6': 'MultiPoint ((963850.90352329798042774 1077652.23999353917315602),(963880.39959512907080352 1077685.35838998109102249))',
            '4-6': 'MultiPoint ((964081.01700186752714217 1077722.2743631626944989),(964211.2347710223402828 1077618.29701916221529245))',
            '1-8': 'MultiPoint ((963750.28136727144010365 1077824.19025488453917205))',
            '6-11': 'MultiPoint ((964079.46952913235872984 1077829.37777462997473776))',
            '4-7': 'MultiPoint ((963849.37875852338038385 1077949.20776149653829634))',
            '3-9': 'MultiPoint ((963662.21440408274065703 1077708.90435272408649325))'
        }
