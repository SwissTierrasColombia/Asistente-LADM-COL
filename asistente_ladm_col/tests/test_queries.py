...
class TestQueries(unittest.TestCase):
    ...
    def test_igac_basic_info_query(self):
        ...
        keywords = {'plot_t_ids': [1416]}
        result = self.query_manager.get_igac_basic_info(self.db_pg, **keywords)
    ...
    def test_igac_legal_info_query(self):
        ...
        keywords = {'plot_t_ids': [1416]}
        result = self.query_manager.get_igac_legal_info(self.db_pg, **keywords)
    ...
    def test_igac_property_record_card_info_query(self):
        ...
        keywords = {'plot_t_ids': [1416]}
        result = self.query_manager.get_igac_property_record_card_info(self.db_pg, **keywords)
    ...
    def test_igac_physical_info_query(self):
        ...
        keywords = {'plot_t_ids': [1416]}
        result = self.query_manager.get_igac_physical_info(self.db_pg, **keywords)
    ...
    def test_igac_economic_info_query(self):
        ...
        keywords = {'plot_t_ids': [1416]}
        result = self.query_manager.get_igac_economic_info(self.db_pg, **keywords)
