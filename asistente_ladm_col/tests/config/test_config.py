TEST_SCHEMAS_MAPPING = {
    ...
    'test_ladm_survey_model': 'test_ladm_survey_model_v1.0.backup',
    'test_ladm_valuation_model': 'test_ladm_valuation_model_v1.0.backup',
    'test_ladm_snr_data': 'test_ladm_snr_data_v1.0.backup',
    'test_ladm_cadastral_manager_data': 'test_ladm_cadastral_manager_data_v1.0.backup',
    'test_ladm_integration': 'test_ladm_integration_v1.0.backup',
    'test_ladm_cadastral_cartography': 'test_ladm_cartography_v1.0.backup',
    ...
    'test_logic_quality_rules': 'test_ladm_logic_quality_rules_v2.9.6.backup',
