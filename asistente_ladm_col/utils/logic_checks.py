...
class LogicChecks(QObject):
    ...
    def parcel_type_and_22_position_of_parcel_number_validation(self, db, rule, error_layer):
        ...
        for record in records:
            mgs_error =  None
            if record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_NO_HORIZONTAL_PROPERTY:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is {parcel_type} the 22nd position of the property code must be 0").format(table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_NO_HORIZONTAL_PROPERTY)
            elif record[self.names.OP_PARCEL_T_TYPE_F] in (PARCEL_TYPE_HORIZONTAL_PROPERTY_PARENT, PARCEL_TYPE_HORIZONTAL_PROPERTY_PARCEL_UNIT):
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is {parcel_type} the 22nd position of the property code must be 9").format(table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_HORIZONTAL_PROPERTY_PARENT + " or " + PARCEL_TYPE_HORIZONTAL_PROPERTY_PARCEL_UNIT)
            elif record[self.names.OP_PARCEL_T_TYPE_F] in (PARCEL_TYPE_CONDOMINIUM_PARENT, PARCEL_TYPE_CONDOMINIUM_PARCEL_UNIT):
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is {parcel_type} the 22nd position of the property code must be 8").format(table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_CONDOMINIUM_PARENT + " or " + PARCEL_TYPE_CONDOMINIUM_PARCEL_UNIT)
            elif record[self.names.OP_PARCEL_T_TYPE_F] in (PARCEL_TYPE_CEMETERY_PARENT, PARCEL_TYPE_CEMETERY_PARCEL_UNIT):
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is {parcel_type} the 22nd position of the property code must be 7").format(table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_CEMETERY_PARENT + " or " + PARCEL_TYPE_CEMETERY_PARCEL_UNIT)
            elif record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_HORIZONTAL_PROPERTY_MEJORA:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is {parcel_type} the 22nd position of the property code must be 5").format(table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_HORIZONTAL_PROPERTY_MEJORA)
            elif record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_NO_HORIZONTAL_PROPERTY_MEJORA:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is {parcel_type} the 22nd position of the property code must be 5").format(table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_NO_HORIZONTAL_PROPERTY_MEJORA)
            elif record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_ROAD:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is {parcel_type} the 22nd position of the property code must be 4").format(table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_ROAD)
            elif record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_PUBLIC_USE:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is {parcel_type} the 22nd position of the property code must be 3").format(table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_PUBLIC_USE)
    ...
    def uebaunit_parcel_validation(self, db, rule, error_layer):
        ...
        for record in records:
            ...
            if record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_NO_HORIZONTAL_PROPERTY:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is '{parcel_type}' you should have 1 plot and 0 building unit but you have {plot_count} plot(s) and {building_unit_count} building unit(s)").format(plot_count=plot_count, building_unit_count=building_unit_count, table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_NO_HORIZONTAL_PROPERTY)
            elif record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_HORIZONTAL_PROPERTY_PARENT:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is '{parcel_type}' you should have 1 plot and 0 building unit but you have {plot_count} plot(s) and {building_unit_count} building unit(s)").format(plot_count=plot_count, building_unit_count=building_unit_count, table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_HORIZONTAL_PROPERTY_PARENT)
            elif record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_CONDOMINIUM_PARENT:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is '{parcel_type}' you should have 1 plot and 0 building unit but you have {plot_count} plot(s) and {building_unit_count} building unit(s)").format(plot_count=plot_count, building_unit_count=building_unit_count, table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_CONDOMINIUM_PARENT)
            elif record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_CEMETERY_PARENT:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is '{parcel_type}' you should have 1 plot and 0 building unit but you have {plot_count} plot(s) and {building_unit_count} building unit(s)").format(plot_count=plot_count, building_unit_count=building_unit_count, table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_CEMETERY_PARENT)
            elif record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_PUBLIC_USE:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is '{parcel_type}' you should have 1 plot and 0 building unit but you have {plot_count} plot(s) and {building_unit_count} building unit(s)").format(plot_count=plot_count, building_unit_count=building_unit_count, table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_PUBLIC_USE)
            elif record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_CONDOMINIUM_PARCEL_UNIT:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is '{parcel_type}' you should have 1 plot and 0 building unit but you have {plot_count} plot(s) and {building_unit_count} building unit(s)").format(plot_count=plot_count, building_unit_count=building_unit_count, table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_CONDOMINIUM_PARCEL_UNIT)
            elif record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_ROAD:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is '{parcel_type}' you should have 1 plot and 0 building and 0 building unit but you have {plot_count} plot(s) and {building_count} building(s) and {building_unit_count} building unit(s)").format(plot_count=plot_count, building_count=building_count, building_unit_count=building_unit_count, table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_ROAD)
            elif record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_CEMETERY_PARCEL_UNIT:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is '{parcel_type}' you should have 1 plot and 0 building and 0 building unit but you have {plot_count} plot(s) and {building_count} building(s) and {building_unit_count} building unit(s)").format(plot_count=plot_count, building_count=building_count, building_unit_count=building_unit_count, table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_CEMETERY_PARCEL_UNIT)
            elif record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_HORIZONTAL_PROPERTY_PARCEL_UNIT:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is '{parcel_type}' you should have 0 plot and 0 building but you have {plot_count} plot(s) and {building_count} building(s)").format(plot_count=plot_count, building_count=building_count, table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_HORIZONTAL_PROPERTY_PARCEL_UNIT)
            elif record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_HORIZONTAL_PROPERTY_MEJORA:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is '{parcel_type}' you should have 0 plot and 1 building and 0 building unit but you have {plot_count} plot(s) and {building_count} building(s) and {building_unit_count} building unit(s)").format(plot_count=plot_count, building_count=building_count, building_unit_count=building_unit_count, table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_HORIZONTAL_PROPERTY_MEJORA)
            elif record[self.names.OP_PARCEL_T_TYPE_F] == PARCEL_TYPE_NO_HORIZONTAL_PROPERTY_MEJORA:
                mgs_error = QCoreApplication.translate("LogicChecksConfigStrings", "When the {parcel_type_field} of {table} is '{parcel_type}' you should have 0 plot and 1 building and 0 building unit but you have {plot_count} plot(s) and {building_count} building(s) and {building_unit_count} building unit(s)").format(plot_count=plot_count, building_count=building_count, building_unit_count=building_unit_count, table=self.names.OP_PARCEL_T, parcel_type_field=self.names.OP_PARCEL_T_TYPE_F, parcel_type=PARCEL_TYPE_NO_HORIZONTAL_PROPERTY_MEJORA)
