...
from ..config.table_mapping_config import VALUATION_BUILDING_UNIT_TABLE
...
class CreateBuildingUnitValuationWizard(QWizard, WIZARD_UI):
    ...
    def prepare_building_unit_valuation_creation(self):
        # Load layers
        self._building_unit_valuation = self.qgis_utils.get_layer(self._db, VALUATION_BUILDING_UNIT_TABLE, load=True)
