...
class MissingSncSuppliesDialog(MissingSuppliesBaseDialog):
    ...
    def accepted(self):
        ...
        self.gpkg_path = os.path.join(self.folder_path, QCoreApplication.translate(
                'MissingSncSuppliesDialog', '{}.gpkg'.format(self.files_name)))
        self.xlsx_path = os.path.join(self.folder_path, QCoreApplication.translate(
                'MissingSncSuppliesDialog', '{}.xlsx'.format(self.files_name)))
    ...
    def validate_inputs(self):
        ...
        if predio_path == QValidator.Acceptable and folder_path == QValidator.Acceptable and files_name == QValidator.Acceptable and self.validate_common_inputs():
            return True
        else:
            return False
