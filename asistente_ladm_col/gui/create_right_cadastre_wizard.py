...
class CreateRightCadastreWizard(QWizard, WIZARD_UI):
    ...
    def adjust_page_1_controls(self):
        ...
        combox_data = self.qgis_utils.fields_mapping(RIGHT_TABLE)
        ...
        if self.rad_refactor.isChecked():
            ...
            if self.mMapLayerComboBox.currentLayer() is not None:
                ...
                if etl_model_feature_count[0] != etl_model_feature_count[1]:
                    self.qgis_utils.func_save_field_mapping(RIGHT_TABLE)
                    if save_field_mapping != None:
                        self.qgis_utils.replace_field_mapping(save_field_mapping, RIGHT_TABLE)
