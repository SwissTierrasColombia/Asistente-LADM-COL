...
from ..config.table_mapping_config import VALUATION_GEOECONOMIC_ZONE_TABLE
from ..utils import get_ui_class

WIZARD_UI = get_ui_class('wiz_create_geoeconomic_zone_valuation.ui')
...
class CreateGeoeconomicZoneValuationWizard(QWizard, WIZARD_UI):
    def __init__(self, iface, db, qgis_utils, parent=None):
        ...
        self.setupUi(self)
        self.iface = iface
        self._geoeconomic_zone_valuation = None
        self._db = db
    ...
    def adjust_page_1_controls(self):
        ...
        if self.rad_refactor.isChecked():
            ...
            self.txt_help_page_1.setHtml(self.help_strings.get_refactor_help_string(VALUATION_GEOECONOMIC_ZONE_TABLE, True))
    ...
    def prepare_building_unit_creation(self):
        ...
        res_layers = self.qgis_utils.get_layers(self._db, {
            VALUATION_GEOECONOMIC_ZONE_TABLE: {'name': VALUATION_GEOECONOMIC_ZONE_TABLE, 'geometry': QgsWkbTypes.PolygonGeometry}
        }, load=True)

        self._geoeconomic_zone_valuation = res_layers[VALUATION_GEOECONOMIC_ZONE_TABLE]
        ...
        form_config = self._geoeconomic_zone_valuation.editFormConfig()
        form_config.setSuppress(QgsEditFormConfig.SuppressOff)
        self._geoeconomic_zone_valuation.setEditFormConfig(form_config)

        # Enable edition mode
        self.iface.layerTreeView().setCurrentLayer(self._geoeconomic_zone_valuation)
        self._geoeconomic_zone_valuation.startEditing()
