...
class SettingsDialog(QDialog, DIALOG_UI):
    ...
    def save_settings(self):
        ...
        settings.setValue('Asistente-LADM_COL/sources/documentary_repository', self.connexion_box.isChecked())
    ...
    def restore_settings(self):
        ...
        self.connexion_box.setChecked(settings.value('Asistente-LADM_COL/sources/documentary_repository', True, bool))
