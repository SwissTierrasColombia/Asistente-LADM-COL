...
class CreateGeoeconomicZoneValuationWizard(SinglePageSpatialWizardFactory):
    set_wizard_is_open_emitted = pyqtSignal(bool)
    set_finalize_geometry_creation_enabled_emitted = pyqtSignal(bool)

    def __init__(self, iface, db, qgis_utils, wizard_settings):
        super(CreateGeoeconomicZoneValuationWizard, self).__init__(iface, db, qgis_utils, wizard_settings)
