...
WIZARD_UI = get_ui_class('wizards/cadastre/rrr/wiz_create_right_cadastre.ui')
...
class CreateRightCadastreWizard(QWizard, WIZARD_UI):
    ...
    def __init__(self, iface, db, qgis_utils):
        ...
        self.EDITING_LAYER_NAME = RIGHT_TABLE
        self._layers = {
    ...
    def finish_feature_creation(self, layerId, features):
        ...
        if len(features) != 1:
            ...
            if not self._layers[self.EDITING_LAYER_NAME][LAYER].getFeature(fid).isValid():
                ...
                right_id = self._layers[self.EDITING_LAYER_NAME][LAYER].getFeature(fid)[ID_FIELD]
