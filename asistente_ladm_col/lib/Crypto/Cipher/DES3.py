...
As an example, encryption can be done as follows:
    ...
    >>> from asistente_ladm_col.lib.Crypto.Cipher import DES
...
from asistente_ladm_col.lib.Crypto.Cipher import blockalgo
from asistente_ladm_col.lib.Crypto.Cipher import _DES3
