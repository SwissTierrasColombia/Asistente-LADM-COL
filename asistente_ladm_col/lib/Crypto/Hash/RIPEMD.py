...
RIPEMD-160_ produces the 160 bit digest of a message.
    ...
    >>> from asistente_ladm_col.lib.Crypto.Hash import RIPEMD
    >>>
    >>> h = RIPEMD.new()
    >>> h.update(b'Hello')
    >>> print h.hexdigest()
...
from asistente_ladm_col.lib.Crypto.Hash.hashalgo import HashAlgo

import asistente_ladm_col.lib.Crypto.Hash._RIPEMD160 as _RIPEMD160
