...
them from known components, exporting them, and importing them.
    ...
    >>> from asistente_ladm_col.lib.Crypto.PublicKey import RSA
    >>>
...
if sys.version_info[0] == 2 and sys.version_info[1] == 1:
    from asistente_ladm_col.lib.Crypto.Util.py21compat import *
from asistente_ladm_col.lib.Crypto.Util.py3compat import *
#from asistente_ladm_col.lib.Crypto.Util.python_compat import *
from asistente_ladm_col.lib.Crypto.Util.number import getRandomRange, bytes_to_long, long_to_bytes

from asistente_ladm_col.lib.Crypto.PublicKey import _RSA, _slowmath, pubkey
from asistente_ladm_col.lib.Crypto import Random

from asistente_ladm_col.lib.Crypto.Util.asn1 import DerObject, DerSequence, DerNull
import binascii
import struct

from asistente_ladm_col.lib.Crypto.Util.number import inverse

from asistente_ladm_col.lib.Crypto.Util.number import inverse

try:
    from asistente_ladm_col.lib.Crypto.PublicKey import _fastmath
except ImportError:
    _fastmath = None
    ...
    def exportKey(self, format='PEM', passphrase=None, pkcs=1):
        ...
        if format=='PEM':
                ...
                if passphrase and keyType.endswith('PRIVATE'):
                    ...
                    import asistente_ladm_col.lib.Crypto.Hash.MD5
                    from asistente_ladm_col.lib.Crypto.Cipher import DES3
                    from asistente_ladm_col.lib.Crypto.Protocol.KDF import PBKDF1
    ...
    def importKey(self, externKey, passphrase=None):
        ...
        if externKey.startswith(b('-----')):
                ...
                if lines[1].startswith(b('Proc-Type:4,ENCRYPTED')):
                    ...
                    import asistente_ladm_col.lib.Crypto.Hash.MD5
                    from asistente_ladm_col.lib.Crypto.Cipher import DES, DES3
                    from asistente_ladm_col.lib.Crypto.Protocol.KDF import PBKDF1
                    if algo==b("DES-CBC"):
