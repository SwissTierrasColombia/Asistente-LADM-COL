...
this:
    ...
    >>> from asistente_ladm_col.lib.Crypto.Signature import PKCS1_PSS
    >>> from asistente_ladm_col.lib.Crypto.Hash import SHA
...
import asistente_ladm_col.lib.Crypto.Util.number
from asistente_ladm_col.lib.Crypto.Util.number import ceil_shift, ceil_div, long_to_bytes
from asistente_ladm_col.lib.Crypto.Util.strxor import strxor
