...
class FortunaAccumulatorTests(unittest.TestCase):
    def setUp(self):
        ...
        from asistente_ladm_col.lib.Crypto.Random.Fortuna import FortunaAccumulator
...
def get_tests(config={}):
    from asistente_ladm_col.lib.Crypto.SelfTest.st_common import list_test_cases
