...
import unittest
from asistente_ladm_col.lib.Crypto.SelfTest.st_common import list_test_cases, a2b_hex, b2a_hex
...
class DSATest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from asistente_ladm_col.lib.Crypto.PublicKey import DSA
        from asistente_ladm_col.lib.Crypto import Random
        from asistente_ladm_col.lib.Crypto.Util.number import bytes_to_long, inverse, size
