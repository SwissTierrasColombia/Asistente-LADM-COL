...
from asistente_ladm_col.lib.ili.ili2dbtools import (get_tool_url,
                                                    get_tool_version)
from asistente_ladm_col.utils.qt_utils import download_file, NetworkError
...
def get_ili2db_bin(tool, db_ili_version, stdout, stderr):
    ...
    if is_version_valid(ili_tool_version, "3.12.2", exact_required_version=False, module_tested=tool_name):
    ...
    if base_configuration.java_path:
        ...
        for java_path in java_paths:
            try:
                ...
                if is_version_valid(java_version.group(1), "1.8.0", exact_required_version=False, module_tested='Java'):
                    return java_path
