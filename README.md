...
La versión actual ([0.6.3](https://github.com/AgenciaImplementacion/Asistente-LADM_COL/releases/tag/0.6.3)) del Asistente LADM_COL depende del plugin [Project Generator v3.2.7.1](https://github.com/AgenciaImplementacion/projectgenerator/releases/tag/3.2.7.1) y permite:
