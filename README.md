...
La versión actual ([1.3.0](https://github.com/AgenciaImplementacion/Asistente-LADM_COL/releases/tag/1.3.0)) del Asistente LADM_COL depende del plugin [QGIS Model Baker v4.1.0.1](https://github.com/AgenciaImplementacion/QgisModelBaker/releases/download/v4.1.0.1/QgisModelBaker.zip) y permite:
